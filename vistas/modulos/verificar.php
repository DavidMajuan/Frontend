			...
			<?php
				...
				if($usuarioVerificado){
					...
					echo '<h3>Gracias</h3>
						...
						<a href="#modalIngresoNutricionista" data-toggle="modal"><button class="btn btn-default backColor btn-lg">INGRESAR</button></a>';
					...
					<a href="#modalRegistroNutricionista" data-toggle="modal"><button class="btn btn-default backColor btn-lg">REGISTRO</button></a>';
