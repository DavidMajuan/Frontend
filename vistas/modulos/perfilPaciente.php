...
<div class="container-fluid">
	...
	<div class="container">
		...
		<ul class="nav nav-tabs">
			...
			<li> 				
	  		...
	  		<li> 				
		  		...
		  		<i class="fa fa-users"></i> NUTRICIONISTAS</a>
			</li>
		...
		<div class="tab-content">
			...
			<div id="perfil" class="tab-pane fade in active">
				...
				<div class="row">
					...
					<form method="post" enctype="multipart/form-data">
						...
						<?php
							...
							$actualizarPerfil = new ControladorUsuariosPaciente();
				...
				<!--	<button class="btn btn-danger btn-md pull-right" id="eliminarUsuario">Eliminar cuenta</button>-->
					...
					$borrarUsuario = new ControladorUsuariosPaciente();
		...
		<div id="compras" class="tab-pane fade ">
			...
			<?php
				...
				if(!$compras){
					...
					echo '<div class="col-xs-12 text-center error404">
						...
						<h2>Aún no tienes Suscripciones realizadas en IlidanNutrition</h2>
						...
						foreach ($productos as $key => $value2) {
							...
							echo '<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										<div class="col-sm-6 col-xs-12">
											...
											if($value2["tipo"] == "virtual"){
												...
												echo '<a href="'.$url.'/curso">
													<button class="btn btn-default pull-left">Ir al Perfil</button>
													</a>';
											...
											echo '<h4 class="pull-right"><small>Suscrito el '.substr($value1["fecha"],0,-8).'</small></h4>
										...
										$comentarios = ControladorUsuariosPaciente::ctrMostrarComentariosPerfil($datos);
			...
			$deseos = ControladorUsuariosPaciente::ctrMostrarDeseos($item);
			...
			if(!$deseos){
				...
				echo '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center error404">
					...
					<h2>Aún no tiene nutricionistas en su lista de deseos</h2>
...
<div  class="modal fade modalFormulario" id="modalComentarios" role="dialog">
	...
	<div class="modal-content modal-dialog">
		...
		<div class="modal-body modalTitulo">
			...
			<h3 class="backColor">CALIFICA Al NUTRICIONISTA</h3>
			...
			<form method="post" onsubmit="return validarComentarioP()">
				...
				<?php
					...
					$actualizarComentario = new ControladorUsuariosPaciente();
