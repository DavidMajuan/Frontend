...
$titulosModulos = array("CONSULTAS GRATUITAS", "NUTRICIONISTAS MÁS SOLICITADOS", "LO MÁS VISTO");
$rutaModulos = array("consultas-gratuitas","nutricionistas-mas-solicitados","lo-mas-visto");

if($titulosModulos[0] == "CONSULTAS GRATUITAS"){
...
if($titulosModulos[1] == "NUTRICIONISTAS MÁS SOLICITADOS"){
