...
<figure class="banner">
	...
	<img src="http://localhost:8080/backend/vistas/img/banner/default.jpg" class="img-responsive" width="100%">	
		...
		<div class="row">
			...
			<div class="col-xs-12 tituloDestacado">
				...
				<div class="col-sm-6 col-xs-12">
					...
					<h1><small>CONSULTAS GRATUITAS </small></h1>
				...
				<div class="col-lg-10 col-md-7 col-sm-8 col-xs-12">
					...
					<h1>
						<small>
							...
							<a href="#" class="pixelProducto">bebidas saludables</a>
				...
				<div class="col-lg-10 col-md-7 col-sm-8 col-xs-12">
					...
					<h1>
						<small>
							...
							<a href="#" class="pixelProducto">Controla tu peso</a>
				...
				<div class="col-lg-10 col-md-7 col-sm-8 col-xs-12">
					...
					<h1>
						<small>
							...
							<a href="#" class="pixelProducto">frutas y verduras</a>
				...
				<div class="col-lg-10 col-md-7 col-sm-8 col-xs-12">
					...
					<h1>
						<small>
							...
							<a href="#" class="pixelProducto">Comidas saludables</a>
		...
		<div class="row">
			...
			<div class="col-xs-12 tituloDestacado">
				...
				<div class="col-sm-6 col-xs-12">
					...
					<h1><small>NUTRICIONISTAS MÁS SOLICITADOS </small></h1>
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost:8080/backend/vistas/img/productos/cursos/curso01.png" class="img-responsive">
				...
				<div class="col-xs-6 enlaces">
					...
					<div class="btn-group pull-right">
						...
						<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="404" imagen="http://localhost:8080/backend/vistas/img/productos/cursos/curso05.jpg" titulo="Curso de Bootstrap" precio="10" tipo="virtual" peso="0"  data-toggle="tooltip" title="Agregar al carrito de compras">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost:8080/backend/vistas/img/productos/cursos/curso04.png" class="img-responsive">
				...
				<div class="col-xs-6 enlaces">
					...
					<div class="btn-group pull-right">
						...
						<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="404" imagen="http://localhost:8080/backend/vistas/img/productos/cursos/curso04.jpg" titulo="Curso de Canvas y Javascript" precio="10" tipo="virtual" peso="0"  data-toggle="tooltip" title="Agregar al carrito de compras">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost:8080/backend/vistas/img/productos/cursos/curso02.jpg" class="img-responsive">
				...
				<div class="col-xs-6 enlaces">
					...
					<div class="btn-group pull-right">
						...
						<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="404" imagen="http://localhost:8080/backend/vistas/img/productos/cursos/curso02.jpg" titulo="Aprende Javascript desde cero" precio="10" tipo="virtual" peso="0"  data-toggle="tooltip" title="Agregar al carrito de compras">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost:8080/backend/vistas/img/productos/cursos/curso03.jpg" class="img-responsive">
			  		...
			  		<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
						...
						<figure>
							...
							<a href="#" class="pixelProducto">
								...
								<img src="http://localhost:8080/backend/vistas/img/productos/cursos/curso06.png" class="img-responsive">
